...
function evalC(Δp::Function, ωm, G, Th, Tc, γh, γc)
    ...
    Σh2 = evalΣ(Ω2, Th, γh)
    Σc2 = evalΣ(Ω2, Tc, γc)
    t -> [(P11(t)^2*Σh1(t))/Ω1(t)+(P21(t)^2*Σc1(t))/Ω1(t), P11(t)^2*Ω1(t)*Σh1(t)+P21(t)^2*Ω1(t)*Σc1(t), 0, (P12(t)^2*Σh2(t))/Ω2(t)(P22(t)^2*Σc2(t))/Ω2(t), P12(t)^2*Ω2(t)*Σh2(t)+P22(t)^2*Ω2(t)*Σc2(t), 0, 0, 0, 0, 0]
end